...
For the full per-command reference (flags, examples, and version-spec syntax), see the per-backend docs: **[AWS](docs/aws.md)**, **[Google Cloud](docs/gcloud.md)**, **[Azure](docs/azure.md)**.
