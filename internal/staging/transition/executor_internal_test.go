...
func TestNewExecutor(t *testing.T) {
	...
	executor := NewExecutor(store.ForService(staging.ServiceParam))
...
func TestExecuteEntry_Add(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/new", state, EntryActionAdd{Value: "new-value"}, nil)
...
func TestExecuteEntry_AddWithDescription(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/new", state, EntryActionAdd{Value: "new-value"}, opts)
	require.NoError(t, err)
...
func TestExecuteEntry_Edit(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionEdit{Value: "updated"}, nil)
	require.NoError(t, err)
...
func TestExecuteEntry_EditWithMetadata(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionEdit{Value: "updated"}, opts)
	require.NoError(t, err)
...
func TestExecuteEntry_Delete(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionDelete{}, nil)
	require.NoError(t, err)
...
func TestExecuteEntry_DeleteWithMetadata(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionDelete{}, opts)
	require.NoError(t, err)
...
func TestExecuteEntry_DeleteCreate_UnstagesTags(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/new", state, EntryActionDelete{}, nil)
	require.NoError(t, err)
...
func TestExecuteEntry_Reset(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionReset{}, nil)
	require.NoError(t, err)
...
func TestExecuteEntry_Error(t *testing.T) {
	...
	result, err := executor.ExecuteEntry(t.Context(), "/app/config", state, EntryActionEdit{Value: "new"}, nil)
...
func TestExecuteTag_Add(t *testing.T) {
	...
	result, err := executor.ExecuteTag(t.Context(), "/app/config", entryState, StagedTags{}, action, &baseTime)
	require.NoError(t, err)
...
func TestExecuteTag_Remove(t *testing.T) {
	...
	result, err := executor.ExecuteTag(t.Context(), "/app/config", entryState, StagedTags{}, action, nil)
	require.NoError(t, err)
...
func TestExecuteTag_UnstageWhenEmpty(t *testing.T) {
	...
	result, err := executor.ExecuteTag(t.Context(), "/app/config", entryState, existingTags, action, nil)
	require.NoError(t, err)
...
func TestLoadEntryState(t *testing.T) {
	...
	t.Run("not staged", func(t *testing.T) {
		...
		state, err := LoadEntryState(t.Context(), store.ForService(staging.ServiceParam), "/app/config", &currentValue)
		require.NoError(t, err)
	...
	t.Run("staged create", func(t *testing.T) {
		...
		state, err := LoadEntryState(t.Context(), store.ForService(staging.ServiceParam), "/app/new", nil)
		require.NoError(t, err)
	...
	t.Run("staged delete", func(t *testing.T) {
		...
		state, err := LoadEntryState(t.Context(), store.ForService(staging.ServiceParam), "/app/config", nil)
		require.NoError(t, err)
...
func TestLoadStagedTags(t *testing.T) {
	...
	t.Run("not staged", func(t *testing.T) {
		...
		tags, baseModifiedAt, err := LoadStagedTags(t.Context(), store.ForService(staging.ServiceParam), "/app/config")
		require.NoError(t, err)
...
func TestExecuteEntry_PersistError(t *testing.T) {
	...
	_, err := executor.ExecuteEntry(t.Context(), "/app/new", state, EntryActionAdd{Value: "new-value"}, nil)
...
func TestExecuteEntry_UnstageTagError(t *testing.T) {
	...
	_, err := executor.ExecuteEntry(t.Context(), "/app/new", state, EntryActionDelete{}, nil)
	assert.ErrorIs(t, err, errMock)
}
...
func TestExecuteTag_PersistError(t *testing.T) {
	...
	_, err := executor.ExecuteTag(t.Context(), "/app/config", entryState, StagedTags{}, action, nil)
	assert.ErrorIs(t, err, errMock)
}
...
func TestLoadEntryState_Error(t *testing.T) {
	...
	_, err := LoadEntryState(t.Context(), store.ForService(staging.ServiceParam), "/app/config", nil)
	assert.ErrorIs(t, err, errMock)
}
...
func TestLoadStagedTags_Error(t *testing.T) {
	...
	_, _, err := LoadStagedTags(t.Context(), store.ForService(staging.ServiceParam), "/app/config")
	assert.ErrorIs(t, err, errMock)
}
