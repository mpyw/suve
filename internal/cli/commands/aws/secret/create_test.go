...
func TestCreateRun(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "create secret",
			opts: cmdsecret.CreateOptions{Name: "my-secret", Value: "secret-value"},
			store: &providermock.Store{
				CreateFunc: func(
		...
		},
		{
			...
			opts: cmdsecret.CreateOptions{Name: "my-secret", Value: "secret-value", Description: "Test description"},
			store: &providermock.Store{
				CreateFunc: func(
