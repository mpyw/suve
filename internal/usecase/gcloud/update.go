...
// Execute runs the update use case. It adds a new version to an existing secret;
// if the secret doesn't exist it returns ErrSecretNotFound. A read failure other
// than not-found is propagated unchanged.
