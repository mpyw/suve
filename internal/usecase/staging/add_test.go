...
func TestAddUseCase_Draft_StagedCreate_Found(t *testing.T) {
	t.Parallel()
...
func TestAddUseCase_Draft_NothingStaged(t *testing.T) {
	t.Parallel()
...
func TestAddUseCase_Draft_GetEntryError(t *testing.T) {
	t.Parallel()
