...
func TestEditUseCase_Baseline_FromAWS(t *testing.T) {
	...
	output, err := uc.Baseline(t.Context(), usecasestaging.BaselineInput{Key: staging.EntryKey{Name: "/app/config"}})
	require.NoError(t, err)
...
func TestEditUseCase_Baseline_FromStagingCreate(t *testing.T) {
	...
	output, err := uc.Baseline(t.Context(), usecasestaging.BaselineInput{Key: staging.EntryKey{Name: "/app/new"}})
	require.NoError(t, err)
...
func TestEditUseCase_Baseline_FetchError(t *testing.T) {
	...
	_, err := uc.Baseline(t.Context(), usecasestaging.BaselineInput{Key: staging.EntryKey{Name: "/app/config"}})
	assert.Error(t, err)
}
...
func TestEditUseCase_Execute_BlocksEditOnDelete(t *testing.T) {
	...
	entry, err := store.GetEntry(t.Context(), staging.ServiceParam, staging.EntryKey{Name: "/app/deleted", Namespace: ""})
	require.NoError(t, err)
...
func TestEditUseCase_Baseline_BlocksWhenDeleteStaged(t *testing.T) {
	...
	_, err := uc.Baseline(t.Context(), usecasestaging.BaselineInput{Key: staging.EntryKey{Name: "/app/deleted"}})
	require.Error(t, err)
	assert.Contains(t, err.Error(), "staged for deletion")
}
...
func TestEditUseCase_Execute_NotStaged_StagesFromAWS(t *testing.T) {
	t.Parallel()

	// When nothing is staged, should fetch from AWS and stage the edit
	store := testutil.NewMockStore()
...
func TestEditUseCase_Execute_NotStaged_SameAsAWS(t *testing.T) {
	t.Parallel()

	// When value matches AWS, should be skipped (no staging)
	store := testutil.NewMockStore()
...
func TestEditUseCase_Execute_StagedCreate_SkipsAWSFetch(t *testing.T) {
	t.Parallel()
...
func TestEditUseCase_Execute_GetEntryError(t *testing.T) {
	t.Parallel()

	// When GetEntry fails (not ErrNotStaged), error should propagate
	store := testutil.NewMockStore()
...
func TestEditUseCase_Baseline_GetEntryError(t *testing.T) {
	t.Parallel()
