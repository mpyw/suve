...
- **GUI** — `internal/gui` (Wails app) + `internal/gui/frontend` (Svelte + Playwright). The sidebar scope form is built from capability `scopeFields` through `frontend/src/lib/scopeFields.ts`.
